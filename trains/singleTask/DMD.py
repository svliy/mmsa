    ...
    def do_train(self, model, dataloader, return_epoch_results=False):
        ...
        while True:
            ...
            with tqdm(dataloader['train']) as td:
                for batch_data in td:
                    ...
                    loss_task = loss_task_all + \
                                loss_task_l_homo + loss_task_v_homo + loss_task_a_homo + \
                                loss_task_l_hetero + loss_task_v_hetero + loss_task_a_hetero + \
                                loss_task_c
                    ...
                    # ort loss
                    # print(output['s_l'].shape) # [46, 16, 50]
                    # print(output['c_l'].shape) # [46, 16, 50]
                    ...
                    ids_dict, feats_dict = [], []
                    for i in range(labels.size(0)):
                        feats_dict.append(c_l_dict[i].view(1, -1))
                        feats_dict.append(c_v_dict[i].view(1, -1))
                        feats_dict.append(c_a_dict[i].view(1, -1))
                    ...
                    loss_homo_dict = self.homo_loss(ids_dict, feats_dict)
                    ...
                    combined_loss = combined_loss + self.args.loss_factor * (loss_homo_dict + loss_hetero_dict)
            ...
            logger.info(
                ...
                f">> train_loss: {round(train_loss, 4)} "
                f">> loss_homo_dict: {round(loss_homo, 4)} "
